...
// package: supersocksr.ppp.android.c
// public final class libopenpppp2 
// public native bool set_tun_safe_queue(bool safe_mode)
__LIBOPENPPP2__(jboolean) Java_supersocksr_ppp_android_c_libopenppp2_set_1tun_1safe_1queue(JNIEnv* env, jobject* this_, jboolean safe_mode) noexcept {
    std::shared_ptr<libopenppp2_application> app = libopenppp2_application::GetDefault();
    if (NULL == app) {
        return false;
    }
    
    IAsynchronousWriteIoQueue::SafeMode(safe_mode);
    return true;
}
...
__LIBOPENPPP2__(jint) Java_supersocksr_ppp_android_c_libopenppp2_is_1tun_1safe_1queue(JNIEnv* env, jobject* this_) noexcept {
    std::shared_ptr<libopenppp2_application> app = libopenppp2_application::GetDefault();
    if (NULL == app) {
        return -1;
    }

    return IAsynchronousWriteIoQueue::SafeMode() ? 1 : 0;
}
...
// package: supersocksr.ppp.android.c
// public final class libopenpppp2 
// public native int set_network_interface(int tun, bool vnet, bool block_quic, bool static_mode, string ip, string mask, string gw)
