...
int PppApplication::PreparedArgumentEnvironment(int argc, const char* argv[]) noexcept
{
    ...
    // Check and set the ssqueue safe mode option for the vnet.
    IAsynchronousWriteIoQueue::SafeMode(ppp::ToBoolean(ppp::GetCommandArgument("--tun-sq", argc, argv).data())); /* SSQ. */
