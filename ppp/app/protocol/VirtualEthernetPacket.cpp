...
#pragma pack(pop)
                ...
                VirtualEthernetPacket&                                          out) noexcept
            {
                ...
                packet_length = ppp::cryptography::ssea::delta_decode(allocator, packet, packet_length, output);
                ...
                int&                                                            out) noexcept
            {
                ...
                out = ppp::cryptography::ssea::delta_encode(allocator, h, message_length, output);
                return output;
            }
